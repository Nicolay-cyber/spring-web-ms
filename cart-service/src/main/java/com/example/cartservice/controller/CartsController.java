...
public class CartsController {
    ...
    @GetMapping("/cartUuidFromSuffix")
    public StringResponse getCartUuidFromSuffix(String username){
     return new StringResponse(cartService.getCartUuidFromSuffix(username));
    }
    @GetMapping("/generate")
